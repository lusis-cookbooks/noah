...
#attribute :timeout, :kind_of => [Integer], :default => node['noah']['client']['timeout']
#attribute :retry_interval, :kind_of => [Integer], :default => node['noah']['client']['retry_interval']
#attribute :noah_server, :kind_of => [String], :default => node['noah']['client']['noah_server']
#attribute :noah_port, :kind_of => [String], :default => node['noah']['client']['noah_port']
